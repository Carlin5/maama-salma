    ...
    <main className="relative flex min-h-screen items-center justify-center px-5 py-12">
      <div className="glass-strong w-full max-w-md rounded-3xl p-8 shadow-2xl">
        ...
        <h1 className="mt-4 font-display text-3xl">
          <span className="shimmer-text">Maama Salma Admin</span>
        </h1>
        <p className="mt-3 font-serif text-lg text-ember-100/70">
          A quiet room for your visitors, messages and campaigns.
        </p>
        <form onSubmit={submit} className="mt-8 space-y-5">
          <label className="block">
            ...
            <input
              value="admin"
              readOnly
              className="mt-2 w-full rounded-2xl border border-gold-500/25 bg-midnight-950/60 px-4 py-3 text-ember-100/70 outline-none"
            />
          </label>
          <label className="block">
            <span className="font-display text-[11px] uppercase tracking-[0.25em] text-gold-400">
            ...
            <input
              ...
              className="mt-2 w-full rounded-2xl border border-gold-500/25 bg-midnight-950/60 px-4 py-3 text-ember-100 outline-none focus:border-gold-400"
            />
          </label>
